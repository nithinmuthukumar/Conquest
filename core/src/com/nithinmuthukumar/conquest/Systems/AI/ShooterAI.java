...
public class ShooterAI extends IteratingSystem {
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        if (finished && state.action == Action.DRAW) {
            ...
            Entity shot = EntityFactory.createShot(attackComp.get(entity).weapon.make().add(engine.createComponent(AllianceComponent.class).create(allianceComp.get(entity).side)), transform.pos, target.target);
